...
<style type="text/css">
	...
	td.Cont_tbL a:hover,td.Cont_tbL a.on,.Cont_tbL a.on_m,.CAL_wid_LT,.CAL_wid_LR,.CAL_LN a{background-image:url("<%=baseUrl%>/websrc/image/Cal_bg.gif");background-repeat:no-repeat}
	...
	.Cont_tit h1{color:#2567AF;margin:0px;padding:0px;font-size:18px;}
	.Cont_tit span{display:block;margin-top:6px;color:#666}
	.Cont{margin:0px}
	.CAL_wid{width:400px;height:auto;border:#A9C8CE 1px solid; border-top-width:0px; position:relative;}
	...
	.CAL_wid_top{ height:43px; background-image:url("<%=baseUrl%>/websrc/image/Cal_bg_tit.gif"); background-repeat:repeat-x}
...
<body onload=initial() style="width:98%">
<!--内容 开始-->
	<div class="Cont">
		<div class="CAL_wid">
...
<tbody>
<tr bgColor=#F2F4F4>
<td height=30> &nbsp;<strong>当前年历：</strong><SPAN class=sm><font color=#333399>公历 </font>
<font style="font-SIZE: 9pt" color=#ffffff>
<SELECT onchange=changeCld() name="SY" id="SY" style="font-size:12px;"> 
...
<font style="font-size: 9pt" color=#ffffff>
<select onchange="changeCld()" name=SM id="SM" style="font-size:12px;">
	<option>1</option>
	<option>2</option>
	<option>3</option>
	<option>4</option>
...
<td valign=top></td></tr></form></tbody>  
  <!--嵌入万年历代码 结束-->			
			</div>
			<!--日历内容区 结束-->
		</div>
