...
<head>
	...
	<meta http-equiv="refresh" content="5;url=<%=baseUrl %>/websrc/page/login/login.jsp"></meta>
</head>
			...
			<table>
				<tr>
					...
					<td>
						...
						如果没有跳转，请<a href='javascript:location.href="<%=baseUrl %>/websrc/page/login/login.jsp";'>点击这里</a>重新登录！
					</td>
				</tr>
			</table>
		</td>
